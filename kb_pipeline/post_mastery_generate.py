...
def _build_prompt(
    ...
    user_lines = [
        ...
        "- Each step must have a clear cause-and-effect link: state which given condition or previous result justifies the calculation, then state what intermediate quantity the calculation produces.",
        "- Make the reasoning flow similar to GSM8K solutions: 'From the problem, ... so ...', 'Since we now know ..., ...', 'This means ...', 'Therefore ...'.",
        ...
        "- If a step produces a value needed later, explicitly name that value, such as total needed per day, remaining amount, combined cost, or final profit.",
