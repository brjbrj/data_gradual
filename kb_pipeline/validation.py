    ...
    return _json_message(
        ...
        ),
        {
            ...
            "rules": [
                ...
                "Use repair_solution only when the question is valid and should remain unchanged.",
    ...
    return _json_message(
        ...
        ),
        {
            ...
            "rules": [
                ...
                "Each step must say what condition or previous result makes the calculation relevant, then state what intermediate value it obtains.",
                "The repaired solution should read like a direct GSM8K-style reasoning chain with cause-and-effect transitions, not like a calculator checklist.",
